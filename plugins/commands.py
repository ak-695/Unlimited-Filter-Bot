...
@akbot_Updates.on_message(filters.command('info') & (filters.private | filters.group))
...
@akbot_Updates.on_message((filters.private | filters.group) & filters.command('status'))
...
@akbot_Updates.on_message(filters.command('start') & filters.private)
...
@akbot_Updates.on_message(filters.command('help') & filters.private)
...
@akbot_Updatesz.on_message(filters.command('about') & filters.private)
